...
sudo apt-get install -y --force-yes build-essential software-properties-common  make cmake libssl-dev pkg-config libreadline-dev zlib1g-dev libglib2.0-dev libsqlite3-dev
